...
/**
 * CheckBox node for building a CheckBox question in the QuizBuilder.
 */
class CheckBoxNode extends OptionNode {
    ...
    //List of CheckBoxes by the options, checked checkboxes represent an answer to the question.

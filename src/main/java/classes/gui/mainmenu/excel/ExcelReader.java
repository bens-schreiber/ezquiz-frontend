    ...
    private boolean validateExcel(Sheet sheet) {
        ...
        for (Row row : sheet) {
            ...
            if (row.getRowNum() > 50) {
                ...
                throw new ExcelValidateException("File exceeds classes.question limit.", row.getRowNum());
            ...
            try {
                ...
                throw new ExcelValidateException("Unsupported classes.question type", row.getRowNum(), 4);
